...
curl -X GET -# -H "Accept: application/json" -H "Authorization: Bearer ${ACCESS_TOKEN}" "https://api.apontador.com.br/v2/places/?q=GPACI&city=Sorocaba&state=SP&list_id=22" -o searchByList.json
